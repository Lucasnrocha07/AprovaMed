...
const NAV = [
  ...
  { to: "/estudar-hoje", label: "Estudar Hoje", icon: CalendarCheck, testid: "nav-estudar-hoje" },
            ...
            <NavLink
              ...
              className={({ isActive }) =>
                `flex items-center gap-3 px-4 py-3 rounded-xl font-semibold text-sm transition-all ${
                  isActive
                    ? "bg-secondary nb-border nb-shadow-sm text-secondary-foreground"
                    : "hover:bg-muted"
                }`
              }
            >
        ...
        <div className="mt-auto flex flex-col gap-2">
          ...
          <div className="flex gap-2">
            <Button
              ...
              className="flex-1 nb-border nb-shadow-sm font-bold"
            >
            ...
            <Button
              ...
              className="nb-border nb-shadow-sm font-bold"
            >
        ...
        <div className="flex overflow-x-auto no-scrollbar gap-1 px-2 py-2">
          {NAV.map((item) => (
            <NavLink
              ...
              className={({ isActive }) =>
                `flex flex-col items-center justify-center min-w-[72px] px-2 py-2 rounded-lg text-[11px] font-bold ${
